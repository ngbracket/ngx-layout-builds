...
const LAYOUT_CONFIG = new InjectionToken(
 ...
 * found in the LICENSE file at https://angular.io/license
 */
const BREAKPOINT = new InjectionToken(
 ...
 */
const BREAKPOINTS = new InjectionToken(
  'Token (@ngbracket/ngx-layout) Breakpoints',
  {
    ...
    factory: () => {
      ...
      const bpFlattenArray = [].concat.apply(
        [],
        (breakpoints || []).map((v) => (Array.isArray(v) ? v : [v]))
      );
      const builtIns = (
