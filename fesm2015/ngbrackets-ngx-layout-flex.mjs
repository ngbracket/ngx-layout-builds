...
import { StyleBuilder, BaseDirective2, ɵmultiply, LAYOUT_CONFIG, validateBasis, CoreModule } from '@ngbrackets/ngx-layout/core';
import { isFlowHorizontal, extendObject, LAYOUT_VALUES, buildLayoutCSS } from '@ngbrackets/ngx-layout/_private-utils';
...
FlexOffsetDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.2", ngImport: i0, type: FlexOffsetDirective, deps: [{ token: i0.ElementRef }, { token: i1$1.Directionality }, { token: FlexOffsetStyleBuilder }, { token: i1.MediaMarshaller }, { token: i1.StyleUtils }], target: i0.ɵɵFactoryTarget.Directive });
...
LayoutGapDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.2", ngImport: i0, type: LayoutGapDirective, deps: [{ token: i0.ElementRef }, { token: i0.NgZone }, { token: i1$1.Directionality }, { token: i1.StyleUtils }, { token: LayoutGapStyleBuilder }, { token: i1.MediaMarshaller }], target: i0.ɵɵFactoryTarget.Directive });
...
//# sourceMappingURL=ngbrackets-ngx-layout-flex.mjs.map
