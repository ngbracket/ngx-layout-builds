...
import { applyCssPrefixes, extendObject, buildLayoutCSS } from '@ngbrackets/ngx-layout/_private-utils';
 ...
 */
const BREAKPOINTS = new InjectionToken('Token (@ngbrackets/ngx-layout) Breakpoints', {
    providedIn: 'root',
    factory: () => {
...
//# sourceMappingURL=ngbrackets-ngx-layout-core.mjs.map
