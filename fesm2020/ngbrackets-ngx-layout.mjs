import { LAYOUT_CONFIG, DEFAULT_CONFIG, BREAKPOINT, SERVER_TOKEN } from '@ngbrackets/ngx-layout/core';
...
const VERSION = new Version('15.0.1-beta.42-2c2a0a3');
...
//# sourceMappingURL=ngbrackets-ngx-layout.mjs.map
